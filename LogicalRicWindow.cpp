...
class LogicalRicWindow : public LogicalOperator
{
public:

    LogicalRicWindow(const string& logicalName, const string& alias):
...
REGISTER_LOGICAL_OPERATOR_FACTORY(LogicalRicWindow, "ric_window");
